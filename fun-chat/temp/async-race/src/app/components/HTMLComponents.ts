...
const h3 = (classNames: string[], text: string) => new BaseComponent({ tag: 'h3', classNames, text });
...
) => new Input({ classNames, id, name, type, placeholder, required, onChange });
...
export { div, p, h1, button, input, label, span, h2, img, select, option, ul, li, a, h3 };
